...
`figures/occlusion_shakedown_surface.png` (generated by the `swarm-figure` CLI).
...
|---|---|---|---|---|---|
| `gauci_scaling.png` | `swarm-figure` on `configs/sweeps/gauci_scaling.toml` | validation §1 | Gauci's constants, n = 2…100, 100 runs/cell | S19, the reproduction | **paper-ready** (methods) |
| `occlusion_shakedown_curve.png` | `swarm-figure curve` | §1 | M0 tight, M1 ‡, FN rate × correlation | S20 | paper-ready (a methods warning) |
| `occlusion_shakedown_surface.png` | `swarm-figure surface` | §1 | as above | S20 | paper-ready |
| `terrain_idea_a_surface.png` | `swarm-figure surface` | §2 | Gauci, α × θ_m grid | A-flatness of reach; the two dials differ | paper-ready |
| `terrain_idea_a_curve.png` | `swarm-figure curve` | §2 | as above | as above | paper-ready |
| `terrain_h2_r0_scaling.png` | `swarm-figure surface` | §4 first pass | four R₀ rows | superseded by the powered sweep | **superseded** — the first pass could not separate λ/R₀ from λ/axle |
| `terrain_h2_powered.png` | `swarm-figure surface --baseline-y` | §4 | five rows breaking the R₀/axle confound, θ_m to 1.0 | R₀ not axle sets the peak | **paper-ready with a caveat**: the ratio-law reading it supports is superseded by §15/§17; use it for the R₀-versus-axle result only, and the caption must keep the widest-axle note |
| `terrain_mechanism.png` | `swarm-figure` | §6 | per-wheel vs scalar-centre, paired seeds | S6, A4 | **paper-ready** |
| `terrain_h3_capability.png` | `swarm-figure paired_panels` | §7 | S2-gauci, S2-searched †, S4-terrain † | S2, A1 | **paper-ready** |
| `terrain_retune_cost.png` | `swarm-figure` | §9 | four rows incl. S4-composite ‡ | S1, S3 | **paper-ready** |
| `terrain_warm_s4.png` | `swarm-figure` | §10 | S2-searched †, S4 cold †, S4-warm † | S2 | **paper-ready** |
